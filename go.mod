module github.com/xudefa/go-boot-kitex
...
exclude google.golang.org/genproto/googleapis/rpc v0.0.0-20260226221140-a57be14db171
...
exclude github.com/jhump/protoreflect v1.8.2
